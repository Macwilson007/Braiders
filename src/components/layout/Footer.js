    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.newsletter}>
        <div className={styles.newsletterInner}>
          <div className={styles.newsletterContent}>
            ...
            <p className={styles.newsletterText}>Get exclusive offers, styling tips, and new arrival alerts.</p>
          </div>
        ...
        <div className={styles.footerGrid}>
          ...
          <div className={styles.footerBrand}>
            <p className={styles.footerBrandText}>
              Lagos&apos;s premier destination for expert hair braiding, styling, and treatments. 
          ...
          <div className={styles.footerColumn}>
            ...
            <ul className={styles.footerLinks}>
              <li><Link href="/services#braiding">Braiding</Link></li>
              <li><Link href="/services#styling">Hair Styling</Link></li>
              <li><Link href="/services#treatments">Treatments</Link></li>
              <li><Link href="/services#coloring">Coloring</Link></li>
              <li><Link href="/services#bridal">Bridal Packages</Link></li>
            </ul>
          </div>

          {/* Contact Info */}
          <div className={styles.footerColumn}>
            <h4 className={styles.footerColumnTitle}>Visit Us</h4>
      ...
      <div className={styles.footerBottom}>
        <div className={styles.footerBottomInner}>
          <p className={styles.copyright}>© {new Date().getFullYear()} Braiders. All rights reserved.</p>
